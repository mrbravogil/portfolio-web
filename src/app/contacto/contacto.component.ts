...
@Component({
  ...
  <div class="w-full flex flex-col gap-10 lg:gap-20">
      <h2 class="text-3xl flex gap-4 items-center">
        <img src="assets/img/message.png" class="w-10" alt="">Contacto
      </h2>
      <div class="w-full lg:pl-5 flex flex-col gap-8 p-5 bg-purple-900 border border-purple-400 rounded-lg text-md">
